...
/datum/station_goal/bluespace_cannon/get_report()
	return list(
		...
		"-Free Union of Vulken Naval Command</blockquote>",
	).Join("\n")
...
/obj/machinery/bsa/middle
	...
	desc = "Contents classified by Free Union of Vulken Naval Command. Needs to be linked with the other BSA parts using a multitool."
