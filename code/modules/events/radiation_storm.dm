...
/datum/round_event/radiation_storm/announce(fake)
	priority_announce("High levels of radiation detected near the colony atmosphere. Inside of the colony is best shielded from radiation.", "Anomaly Alert", ANNOUNCER_RADIATION)
