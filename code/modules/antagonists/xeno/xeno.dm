...
/datum/team/xeno/captive/roundend_report()
	...
	parts += "<span class='neutraltext'>Free Union of Vulken thanks the crew of [station_name()] for providing much needed research data on <b>[thank_you_message]</b>.</span>"
