...
/obj/item/paper/calling_card
	...
	default_raw_text = {"
	<b>**Death to Free Union Of Vulken.**</b><br><br>

	Only through the inviolable cooperation of corporations known as The Syndicate, can Free Union Of Vulken and its autocratic tyrants be silenced.
	The outcries of Free Union Of Vulken's employees are squelched by the suffocating iron grip of their leaders. If you read this, and understand
	why we fight, then you need only to look where Free Union Of Vulken doesn't want you to find us to join our cause. Any number of our companies
	...
	<b>Waffle Corporation:</b> They fight for the return of healthy corporate competition, snuffed out by Free Union Of Vulken's monopoly.<br><br>
