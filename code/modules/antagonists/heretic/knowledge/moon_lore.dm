...
/datum/heretic_knowledge/moon_grasp
	...
	desc = "Your Psyonics Grasp will cause them to hallucinate everyone as lunar mass, \
...
/datum/heretic_knowledge/mark/moon_mark
	name = "Mark of Moon"
	desc = "Your Psyonics Grasp now applies the Mark of Moon. The mark is triggered from an attack with your Moon Blade. \
