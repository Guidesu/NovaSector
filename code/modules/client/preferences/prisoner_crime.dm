...
/datum/prisoner_crime/espionage
	...
	desc = "Conducted espionage against Free Union of Vulken for commercial purposes."
	tattoos = 1
...
/datum/prisoner_crime/enemy_of_the_corp
	...
	desc = "Acted as, or knowingly aided, an enemy of Free Union of Vulken."
	tattoos = 1

/datum/prisoner_crime/grand_sabo
	name = "Grand Sabotage"
	desc = "Engaged in malicious destructive actions, seriously threatening Free Union of Vulken employees and or infrastructure."
	tattoos = 2
