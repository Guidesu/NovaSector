...
/datum/bounty/virus/New()
	...
	description = "Free Union of Vulken is interested in a virus with a [stat_name] stat of exactly [stat_value]. Central Command will pay handsomely for such a virus."
