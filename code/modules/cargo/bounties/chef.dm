/datum/bounty/item/chef/birthday_cake
	name = "Birthday Cake"
	description = "Free Union Of Vulken's birthday is coming up! Ship Central Command a birthday cake to celebrate!"
...
/datum/bounty/reagent/chef/soup
	name = "Soup"
	description = "To quell the homeless uprising, Free Union Of Vulken will be serving soup to all underpaid workers."
...
/datum/bounty/item/chef/onionrings
	name = "Onion Rings"
	description = "Free Union Of Vulken is remembering Saturn day. Ship onion rings to show the station's support."
	reward = CARGO_CRATE_VALUE * 6
	required_count = 3
...
/datum/bounty/item/chef/hotdog
	name = "Hot Dog"
	description = "Free Union Of Vulken is conducting taste tests to determine the best hot dog recipe. Ship your station's version to participate."
	reward = CARGO_CRATE_VALUE * 16
...
/datum/bounty/item/chef/chawanmushi
	name = "Chawanmushi"
	description = "Free Union Of Vulken wants to improve relations with its sister company, Japanotrasen. Ship Chawanmushi immediately."
	reward = CARGO_CRATE_VALUE * 16
...
/datum/bounty/item/chef/pancakes
	name = "Pancakes"
	description = "Here at Free Union Of Vulken we consider employees to be family. And you know what families love? Pancakes. Ship a baker's dozen."
	reward = CARGO_CRATE_VALUE * 10
	required_count = 13
