/datum/bounty/item/assistant/strange_object
	name = "Strange Object"
	description = "Free Union Of Vulken has taken an interest in strange objects. Find one in maintenance, and ship it off to CentCom right away."
	reward = CARGO_CRATE_VALUE * 2.4
	wanted_types = list(/obj/item/relic = TRUE)

/datum/bounty/item/assistant/scooter
	name = "Scooter"
	description = "Free Union Of Vulken has determined walking to be wasteful. Ship a scooter to CentCom to speed operations up."
...
/datum/bounty/item/assistant/skateboard
	name = "Skateboard"
	description = "Free Union Of Vulken has determined walking to be wasteful. Ship a skateboard to CentCom to speed operations up."
...
/datum/bounty/item/assistant/ied
	name = "IED"
	description = "Free Union Of Vulken's maximum security prison at CentCom is undergoing personnel training. Ship a handful of IEDs to serve as a training tools."
	reward = CARGO_CRATE_VALUE * 4
	required_count = 3
