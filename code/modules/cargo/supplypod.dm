...
/obj/structure/closet/supplypod
	...
	desc = "A Free Union of Vulken supply drop pod."
...
/obj/item/disk/cargo/bluespace_pod //Disk that can be inserted into the Express Console to allow for Advanced Bluespace Pods
	...
	desc = "This disk provides a firmware update to the Express Supply Console, granting the use of Free Union of Vulken's Bluespace Drop Pods to the supply department."
