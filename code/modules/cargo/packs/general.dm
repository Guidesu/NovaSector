...
/datum/supply_pack/misc/bicycle
	name = "Bicycle"
	desc = "Free Union of Vulken reminds all employees to never toy with powers outside their control."
...
/datum/supply_pack/misc/book_crate
	name = "Book Crate"
	desc = "Surplus from the Free Union of Vulken Archives, these seven books are sure to be good reads."
...
/datum/supply_pack/misc/commandkeys
	...
	desc = "A pack of encryption keys that give access to the command radio network. \
		Free Union of Vulken reminds unauthorized employees not to eavesdrop in on secure communications channels, \
...
/datum/supply_pack/misc/empty
	...
	desc = "Presenting the New Free Union of Vulken-Brand Bluespace Supplypod! Transport cargo with grace and ease! \
