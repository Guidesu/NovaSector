...
/obj/item/paper/crumpled/ruins/snowdin/misc1
	...
	default_raw_text = {"Holy shit, what a rush! Those Free Union of Vulken bastards didn't even know what hit 'em! All five of us dropped in right on the captain, didn't even have time to yell! We were in and out with that disk in mere minutes!
...
/obj/item/paper/fluff/awaymissions/snowdin/profile/overseer
	...
	default_raw_text = {"<b><center>Personnel Log</b></center><br><br><b>Name:</b>Caleb Reed<br><b>Age:</b>38<br><b>Gender:</b>Male<br><b>On-Site Profession:</b>Outpost Overseer<br><br><center><b>Information</b></center><br><center>Caleb Reed lead several expeditions
		among uncharted planets in search of plasma for Free Union of Vulken, scouring from hot savanas to freezing arctics. Track record is fairly clean with only incidient including the loss of two researchers during the
...
/obj/item/paper/fluff/awaymissions/snowdin/profile/sec1
	...
	default_raw_text = {"<b><center>Personnel Log</b></center><br><br><b>Name:</b>James Reed<br><b>Age:</b>43<br><b>Gender:</b>Male<br><b>On-Site Profession:</b>Outpost Security<br><br><center><b>Information</b></center><br><center>James Reed has been a part
		of Free Union of Vulken's security force for over 20 years, first joining in 22XX. A clean record and unwavering loyalty to the corperation through numerous deployments to various sites makes him a valuable asset to Natotrasen
		when it comes to keeping the peace while prioritizing Free Union of Vulken privacy matters. "}
...
/obj/item/paper/fluff/awaymissions/snowdin/secnotice
	...
	default_raw_text = {"YOu have been assigned to this Arctic Post with intention of protecting Free Union of Vulken assets and ensuring vital information is kept secure while the stationed crew obeys protocol. The picked
...
/obj/item/paper/fluff/awaymissions/snowdin/mining
	...
	default_raw_text = {"This cold-ass planet is the new-age equivalent of striking gold. Huge deposits of plasma and literal streams of plasma run through the caverns under all this ice and we're here to mine it all.\
		Free Union of Vulken pays by the pound, so get minin' boys!"}
...
/obj/item/disk/holodisk/snowdin/weregettingpaidright
	...
	DELAY 10
	SAY Nah. I've been feeding the AI the results for the past 2 weeks to sift through the garbage and haven't seen anything out of the usual, at least whatever Free Union of Vulken is looking for.
	DELAY 45
	NAME Jacob Ullman
	DELAY 10
	SAY Figured as much. Dunno what Free Union of Vulken expects to find out here past the plasma. At least we're getting paid to fuck around for a couple months while the AI does the hard work.
	DELAY 45
	NAME Elizabeth Queef
	DELAY 10
	SAY . . .
	...
	NAME Caleb Reed
	DELAY 10
	SAY Paid in experience! That's the Free Union of Vulken Motto!
	DELAY 30;"}
...
/obj/item/disk/holodisk/snowdin/welcometodie
	...
	DELAY 30
	SAY Free Union of Vulken is pleased to have you working in one of the many top-of-the-line research posts within the $%@!! sector!
	DELAY 30
