...
/obj/item/paper/pamphlet/gateway
	default_raw_text = "<b>Welcome to the Free Union Of Vulken Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the Free Union Of Vulken Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the Free Union Of Vulken Gateway project. All away destinations have \
			been fully scanned by a Free Union Of Vulken expeditionary team, and are certified to be 100% safe. \
			We've even left a case of space beer along with the basic materials you'll need to expand \
			Free Union Of Vulken's operational area and start your new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All Free Union Of Vulken approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the Free Union Of Vulken Gateway Project, you will be on the frontiers of space. \
