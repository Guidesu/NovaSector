...
/datum/action/cooldown/spell/sanguine_strike
	name = "Hemokinetic Strike"
	desc = "Empower your next melee attack with hemokinetic energy, causing increased damage, healing you for the inflicted damage, and replenishing your vitality."
	...
	invocation = "sanguis pro sanguine"
