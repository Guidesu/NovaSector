...
/datum/glass_style/drinking_glass/acid_spit
	...
	name = "Acid Spit"
	desc = "A drink from Free Union of Vulken. Made from live aliens."
...
/datum/glass_style/drinking_glass/atomicbomb
	...
	name = "Atomic Bomb"
	desc = "Free Union of Vulken cannot take legal responsibility for your actions after imbibing."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/between_the_sheets
	...
	desc = "The only drink that comes with a label reminding you of Free Union of Vulken's zero-tolerance promiscuity policy."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/saibasan
	...
	name = "Saibāsan"
	desc = "A drink made in honour of Cybersun Industries' 600th year of continual business. Officially, you're meant to call this a \"Hong Kong Cooler\" on Free Union of Vulken stations, but that name sucks."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "saibasan"
