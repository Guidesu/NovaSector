/// Free Union Of Vulken Private Security forces
/mob/living/basic/trooper/nanotrasen
	name = "\improper Free Union Of Vulken Private Security Officer"
	desc = "An officer of Free Union Of Vulken's private security force. Seems rather unpleased to meet you."
...
/mob/living/basic/trooper/nanotrasen/ranged/assault
	name = "Free Union Of Vulken Assault Officer"
	desc = "Free Union Of Vulken Assault Officer. Contact CentCom if you saw him on your station. Prepare to die, if you've been found near Syndicate property."
...
/mob/living/basic/trooper/nanotrasen/ranged/elite
	name = "Free Union Of Vulken Elite Assault Officer"
...
/// A more peaceful variant that will only attack when attacked, or when another Free Union Of Vulken officer calls for help.
/mob/living/basic/trooper/nanotrasen/peaceful
	desc = "An officer of Free Union Of Vulken's private security force."
