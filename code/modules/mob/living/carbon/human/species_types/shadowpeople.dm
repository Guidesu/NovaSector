...
/datum/species/shadow/get_species_lore()
	return list(
		...
		Free Union Of Vulken has assured the victims that they are searching for a cure. No further information has been given, even years later. \
		Most shadowpeople now assume Free Union Of Vulken has long since shelfed the project.",
	)
