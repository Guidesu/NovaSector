...
/obj/machinery/computer/terminal/derelict/bridge
	...
	-Free Union of Vulken Naval Command -- Identified Shift Divergences: Overflow bureaucracy mistake - It seems for some reason we put out the wrong job-listing for the overflow role this shift...I hope you like captains.")
...
/obj/item/tape/captains_log
	...
	storedinfo = list( // the captain recorded this in several segements
		...
		"\[00:55\] To think Free Union of Vulken loves to call this hellhole:",
		...
		"\[28:25\] Sure, I could upload it with all the evidence and dirt i've found over the years on Free Union of Vulken",
