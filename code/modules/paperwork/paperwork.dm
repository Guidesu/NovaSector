...
/obj/item/paperwork/service/Initialize(mapload)
	...
	detailed_desc += span_info(" You begin scanning over the document. This is a standard Free Union of Vulken NT-435Z3 form used for requests to Central Command.")
