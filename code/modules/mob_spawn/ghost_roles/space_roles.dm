...
/obj/effect/mob_spawn/ghost_role/human/oldsec
	...
	you_are_text = "You are a security officer working for Free Union of Vulken, stationed onboard a state of the art research station."
...
/obj/effect/mob_spawn/ghost_role/human/oldeng
	...
	icon_state = "sleeper"
	mob_species = /datum/species/human
	you_are_text = "You are an engineer working for Free Union of Vulken, stationed onboard a state of the art research station."
...
/obj/effect/mob_spawn/ghost_role/human/oldsci
	...
	icon_state = "sleeper"
	mob_species = /datum/species/human
	you_are_text = "You are a scientist working for Free Union of Vulken, stationed onboard a state of the art research station."
	flavour_text = "You vaguely recall rushing into a cryogenics pod due to an oncoming radiation storm. \
	The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod."
	important_text = "Work as a team with your fellow survivors and do not abandon them."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/comms/space
	...
	flavour_text = "Monitor enemy activity as best you can, and try to keep a low profile. Use the communication equipment to provide support to any field agents, and sow disinformation to throw Free Union of Vulken off your trail. Do not let the base fall into enemy hands!"
