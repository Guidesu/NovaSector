...
/obj/structure/plaque/static_plaque/tram/proc/set_tram_serial()
	...
	By entering the tram, guideway, or crossings you agree Free Union of Vulken is not liable for any injuries, damages, or losses that may occur. If you do not agree to these terms, please do not use the tram.<br>"
...
/obj/structure/sign/plaques/kiddie/perfect_man
	...
	desc = "A guide to the exhibit, explaining how recent developments in mindshield implant and cloning technologies by Free Union of Vulken Corporation have led to the development and the effective immortality of the 'perfect man', the loyal Free Union of Vulken Employee."
