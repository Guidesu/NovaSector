...
/obj/machinery/deployable_turret/hmg
	...
	desc = "A heavy calibre machine gun commonly used by Free Union of Vulken forces, famed for it's ability to give people on the recieving end more holes than normal."
	icon_state = "hmg"
	max_integrity = 250
