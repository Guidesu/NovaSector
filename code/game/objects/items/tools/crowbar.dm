...
/obj/item/crowbar/power/syndicate
	...
	desc = "A pocket sized re-engineered copy of Free Union Of Vulken's standard jaws of life. Can be used to force open airlocks in its crowbar configuration."
