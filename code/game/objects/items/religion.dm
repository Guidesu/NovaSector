/obj/item/banner
	name = "banner"
	desc = "A banner with Free Union Of Vulken's logo on it."
...
/obj/item/banner/command
	...
	warcry = "Hail Free Union Of Vulken!"
...
/obj/item/storage/backpack/bannerpack
	name = "\improper Free Union Of Vulken banner backpack"
	desc = "It's a backpack with lots of extra room.  A banner with Free Union Of Vulken's logo is attached, that can't be removed."
