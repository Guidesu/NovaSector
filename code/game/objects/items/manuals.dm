...
/obj/item/book/manual/ripley_build_and_repair
	...
	starting_content = {"<html>
				...
				<li>Install the internal armor plating (Not included due to Free Union Of Vulken regulations. Can be made using 5 iron sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to Free Union Of Vulken regulations. Can be made using 5 reinforced iron sheets.)</li>
				...
				<h2>Operation</h2>
				Please consult the Free Union Of Vulken compendium "Robotics for Dummies".
			"}
...
/obj/item/book/manual/nuclear
	...
	starting_content = {"<html>
			...
			Today's crash course will deal with the operation of a Fusion Class Free Union Of Vulken made Nuclear Device.<br>
			...
			Note: Free Union Of Vulken is a pain in the neck.<br>
			...
			Intelligence Analysts believe that normal Free Union Of Vulken procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</body>
			</html>"}
