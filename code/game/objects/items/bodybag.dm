...
/obj/item/bodybag/environmental/prisoner/syndicate
	...
	desc = "An alteration of Free Union of Vulken's environmental protection bag which has been used in several high-profile kidnappings. Designed to keep a victim unconscious, alive, and secured until they are transported to a required location."
	icon = 'icons/obj/medical/bodybag.dmi'
