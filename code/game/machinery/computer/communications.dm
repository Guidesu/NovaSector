...
/obj/machinery/computer/communications/proc/hack_console(mob/living/hacker)
	...
	switch(picked_option)
		...
		if(HACK_THREAT) // Force an unfavorable situation on the crew
			priority_announce(
				"Attention crew, the Free Union of Vulken Department of Intelligence has received intel suggesting increased enemy activity in your sector beyond that initially reported in today's threat advisory.",
				"[command_name()] High-Priority Update",
			)
