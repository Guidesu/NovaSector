...
/datum/map_config
	// Metadata
	var/config_filename = "_maps/deltastation.json"
	...
	var/map_name = "Delta Station"
	var/map_path = "map_files/Deltastation"
	var/map_file = "DeltaStation2.dmm"
	...
	var/localized_trading_hub_types = list(/datum/trade_hub/randomname)
