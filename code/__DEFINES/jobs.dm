...
#define JOB_NT_REP "Free Union of Vulken Consultant"
// Free Union of Vulken Naval Command jobs
...
#define DEPARTMENT_BITFLAG_CIVILLIAN (1<<11)
#define DEPARTMENT_BITFLAG_MISC (1<<12)
