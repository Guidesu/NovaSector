...
PROCESSING_SUBSYSTEM_DEF(reagents)
	...
	wait = 0.25 SECONDS //You might think that rate_up_lim has to be set to half, but since everything is normalised around seconds_per_tick, it automatically adjusts it to be per second. Psyonautic!
