...
/obj/item/organ/internal/cyberimp/arm/emt_triage
	...
	desc = "Pioneered by Free Union of Vulken Pharmaceuticals for use in their frontier postings, this set of in-arm augments allows medical staff to perform basic life-saving surgeries out on the field with the assistance of a bladed instrument."
