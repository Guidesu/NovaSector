...
/datum/antagonist/ert/request_911/greet()
	var/missiondesc =  ""
	missiondesc += "<B><font size=5 color=red>You are NOT a Free Union of Vulken Employee. You work for the Sol Federation as a [role].</font></B>"
...
/obj/item/solfed_reporter/treason_reporter/questions(mob/user)
	var/list/list_of_questions = list(
		"Treason is the crime of attacking a state authority to which one owes allegiance. The station is located within Sol Federation space, \
			and owes allegiance to the Sol Federation despite being owned by Free Union of Vulken. Did the station engage in this today?",
...
/datum/antagonist/ert/pizza/false_call/greet()
	var/missiondesc =  ""
	missiondesc += "<B><font size=5 color=red>You are NOT a Free Union of Vulken Employee. You work for Dogginos as a delivery person.</font></B>"
...
/datum/antagonist/ert/pizza/leader/false_call/greet()
	var/missiondesc =  ""
	missiondesc += "<B><font size=5 color=red>You are NOT a Free Union of Vulken Employee. You work for Dogginos as a Regional Manager.</font></B>"
