...
/datum/pirate_gang/nri_raiders/generate_message(payoff)
	...
	var/station_designation = pick_weight(list(
		"Free Union of Vulken Research Station" = 70,
		"Free Union of Vulken Refueling Outpost" = 5,
		"Free Union of Vulken Pharmaceuticals Chemical Factory" = 5,
