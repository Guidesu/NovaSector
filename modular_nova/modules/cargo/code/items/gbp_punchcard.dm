...
/obj/item/gbp_punchcard
	...
	desc = "The Good Assistant Points program is designed to supplement the income of otherwise unemployed or unpaid individuals on board Free Union Of Vulken vessels and colonies.<br>\
