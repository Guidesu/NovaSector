...
/datum/mod_theme/marines
	name = "marine"
	desc = "Developed by Free Union of Vulken in collaboration with multiple high-profile contractors, this specialized suit is made for high-intensity combat."
	extended_desc = "A black and blue suit of Free Union of Vulken design made to be utilized by corporate space marines \
