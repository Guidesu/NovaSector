...
/obj/structure/sign/poster/contraband/shipstation
	...
	desc = "This poster depicts the long deprecated 'Ship' class 'station' in it's hayday. Surprisingly, the poster seems to be Free Union Of Vulken official; though with how hush they've been on the topic..." //A disaster as big as Ship deserves a scandalous coverup.
	icon = 'modular_nova/modules/aesthetics/posters/contraband.dmi'
...
/obj/structure/sign/poster/contraband/killingjoke // I like Batman :)))
	...
	desc = "A poster boldly stating that being insane abord Free Union Of Vulken stations isn't required. But it doesn't hurt to have!"
	icon = 'modular_nova/modules/aesthetics/posters/contraband.dmi'
