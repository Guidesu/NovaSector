...
/obj/item/gun/ballistic/shotgun/automatic/combat
	...
	desc = "A semi-automatic Free Union Of Vulken Peacekeeper shotgun with tactical furnishing and heavier internals meant for sustained fire. Lacks a threaded barrel."
...
/obj/item/gun/ballistic/automatic/ar/modular
	...
	desc = "Free Union Of Vulken's prime ballistic option based on the Stoner design, fitted with a light polymer frame and other tactical furniture, and chambered in .277 Aestus - nicknamed 'Boarder' by Special Operations teams."
	icon = 'modular_nova/modules/aesthetics/guns/icons/guns_gubman2.dmi'
	icon_state = "arg"
