/datum/computer_file/program/news_archive
	...
	filedesc = "Free Union of Vulken News Archives"
	downloader_category = PROGRAM_CATEGORY_DEVICE
	program_open_overlay = "generic"
	extended_desc = "This program lets you view out-of-circulation articles from the Free Union of Vulken News Network."
...
/datum/computer_file/program/news_archive/proc/generate_stories()
	...
	for(var/story in uncompiled_stories)
		...
		if(!("title" in uncompiled_stories[story]))
			uncompiled_stories[story]["title"] = "Free Union of Vulken News Broadcast"
