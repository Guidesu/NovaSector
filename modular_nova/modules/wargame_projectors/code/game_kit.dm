...
/obj/item/book/manual/wargame_rules
	...
	icon_state = "book"
	starting_author = "Free Union of Vulken Naval Wargames Commission"
	...
	starting_content = {"
				...
				<body>
				<center>
				<b style='font-size: 12px;'>Official publication of the Free Union of Vulken Naval Wargames Commission</b>
				...
				<h2>Example Ruleset</h2>
					...
					<b>Playing the Game</b> <br>
						...
						<br>
						*Wargame: Blue Lizard is a copyright protected title under ownership of Free Union of Vulken
				</body>
				</html>
			"}
...
/obj/item/book/manual/wargame_rules/examples
	...
	starting_content = {"
				...
				<br>
				<h2>Example Ships</h2>
					<b>Free Union of Vulken</b> <br>
					Free Union of Vulken's fleet has historically been focused on quick response, especially due to the spread
					of Free Union of Vulken assets across the galaxy. Their ships are often built to simply get to a location
					...
					ship types due to modern designs being classified.
						...
						<br>
						-- Battlecruiser -- <br>
						The largest commonly fielded ship in Free Union of Vulken's navy, a fast response vessel with enough guns and
					...
					<br>
					<b>NRI</b> <br>
					The NRI's navy has always been at least a contender to SolFed's and Free Union of Vulken's own, heavily focused on missiles
				...
				<h2>Example Scenarios</h2>
					-- Free Union of Vulken/NRI Station Skirmish -- <br>
					A Free Union of Vulken sponsored station located in NRI border territories has violated several regulations
					and laws, and an NRI patrol fleet has been sent to repossess the station. A force of Free Union of Vulken
					ships jumps in just in time to intercept. <br>
					- Takes place with a Free Union of Vulken station surrounded by a large asteroid field of some kind between
					...
					A convoy of Free Union of Vulken cargo vessels, escorted by a small patrol force, come under attack by a sizeable
