...
/datum/opposing_force_equipment/gadget_stealth/syndiejaws
	...
	description = "Based on a Free Union of Vulken model, this powerful tool can be used as both a crowbar and a pair of wirecutters. \
...
/datum/opposing_force_equipment/gadget_stealth/microlaser
	...
	description = "A radioactive microlaser disguised as a standard Free Union of Vulken health analyzer. When used, it emits a \
