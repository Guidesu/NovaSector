...
/datum/controller/subsystem/dynamic/proc/send_trait_report()
	...
	<p style=\"color: grey; text-align: justify;\">This label certifies an Intern has reviewed the above before sending. This document is the property of Free Union of Vulken Corporation.</p>"
