/obj/item/construction/rcd/arcd/mattermanipulator
	...
	desc = "A strange, familiar yet distinctly different analogue to the Free Union Of Vulken standard RCD. Works at range, and can deconstruct reinforced walls. Reload using metal, glass, or plasteel."
