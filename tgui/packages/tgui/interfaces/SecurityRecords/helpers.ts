...
export const getDefaultPrintDescription = (
  ...
  switch (printType) {
    ...
    case PRINTOUT.Wanted:
      return `A poster declaring ${name} to be a wanted criminal, wanted by Free Union of Vulken. Report any sightings to security immediately.`;
    case PRINTOUT.Missing:
      return `A poster declaring ${name} to be a missing individual, missed by Free Union of Vulken. Report any sightings to security immediately.`;
  }
};
